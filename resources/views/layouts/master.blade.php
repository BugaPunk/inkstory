        ...
        <nav class="navbar navbar-expand-md navbar-light bg-dark shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('/images/logobebidas.png') }}" alt="LOGO" class="img-fluid" style="max-height: 50px;">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        @auth
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-light" href="{{ route('role.index') }}">Rol</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-light" href="{{ route('permission.index') }}">Permisos</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-light" href="{{ route('salidas.index') }}">Ventas</a>
                            </li>
                        @endauth
